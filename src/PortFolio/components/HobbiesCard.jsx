...
const HobbiesCard = ({ className, cardId, onMouseEnter, onMouseLeave }) => {
  ...
  return (
    ...
    p-4`} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
      ...
      <h1 className={`text-xl font-medium italic items-start flex px-2 py-2 h-auto w-full border-b-2 pb-4 border-[#44444444]`}>
        Hobbies:
      </h1>
